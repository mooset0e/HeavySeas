...
void HUD::render(const ShipStats& ship, const Wind& wind, float speedFactor) {
    ...
    SDL_Color speedCol = speedFactor > 0.7f
        ? SDL_Color{ 70, 200, 70, 255 }
        : speedFactor > 0.45f
            ? SDL_Color{ 220, 180, 50, 255 }
            : SDL_Color{ 220, 80, 60, 255 };
    ui_.drawHealthBar((int)(speedFactor * 100), 100, speedBarBg, speedCol);
