...
enum class PortView { MainMenu, Tavern, Shipyard, TradingPost, GovernorsMansion };

class PortScreen {
public:
    PortScreen(UIRenderer& ui, ShipStats& ship, const Town& town, Port& port);
...
private:
    ...
    void handleSubView(const InputState& input);
